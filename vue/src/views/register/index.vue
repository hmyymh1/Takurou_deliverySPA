<template lang="">
    <div id='register' class="min-h-screen w-screen">
        <header class="sticky top-0 z-40">
            <Nav/>
        </header>
        <div class="min-h-full flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8" id='registerBox'>
...
import { PostRequest } from "@/apis/read.js"
